package Day08.Ex14_Collection.Set;
...
public class LottoSet {
	...
	public static void main(String[] args) {
		...
		while ( lottoSet.size() < 6 ) {
			int num = random.nextInt(45) + 1;		// 1~45 랜덤수
			boolean check = lottoSet.add(num);	// 중복❌ : true, 중복⭕ : false
			if( !check ) {
				System.out.println(num + "번 중복!!! 다시 뽑습니다!");
			}
		}
